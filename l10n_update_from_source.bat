...
mkdir ..\..\deps\release\l10n\locales\en-US\installer\HlaeFfmpegMigrate\
py -3 ..\..\deps\dev\wxl-po-tools\wxl2pot.py -f -l LangId lang/en-US.wxl ..\..\deps\release\l10n\locales\en-US\installer\HlaeFfmpegMigrate\messages.pot
cd ..\..
