...
AFXADDR_DECL(other_gpGlobals_OFS_absoluteframetime)
AFXADDR_DECL(other_gpGlobals_OFS_curtime)
AFXADDR_DECL(other_gpGlobals_OFS_interpolation_amount)
AFXADDR_DECL(other_gpGlobals_OFS_interval_per_tick)
...
AFXADDR_DECL(garrysmod_client_C_BaseAnimating_RecordBones)
