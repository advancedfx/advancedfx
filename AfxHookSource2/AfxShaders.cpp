...
ID3D11VertexShader * CAfxVertexShader::GetVertexShader()
{
	return m_VertexShader;
}

void CAfxVertexShader::BeginDevice(ID3D11Device * device, const wchar_t * name)
{
	size_t size;
	void * so = LoadShaderFileInMemory(name,size);

	if(so && SUCCEEDED(device->CreateVertexShader(so, size, nullptr, &m_VertexShader)))
...
ID3D11PixelShader * CAfxPixelShader::GetPixelShader()
{
	return m_PixelShader;
}

void CAfxPixelShader::BeginDevice(ID3D11Device * device, const wchar_t * name)
{
	size_t size;
	void * so = LoadShaderFileInMemory(name,size);

	if(so && SUCCEEDED(device->CreatePixelShader(so, size, nullptr, &m_PixelShader)))
...
ID3D11VertexShader * CAfxAcsVertexShader::GetVertexShader()
{
	return m_VertexShader;
}

void CAfxAcsVertexShader::BeginDevice(ID3D11Device * device, const wchar_t * name, int combo)
{
	size_t size;
	void * so = LoadFromAcsShaderFileInMemory(name, combo, size);
...
ID3D11PixelShader * CAfxAcsPixelShader::GetPixelShader()
{
	return m_PixelShader;
}

void CAfxAcsPixelShader::BeginDevice(ID3D11Device * device, const wchar_t * name, int combo)
{
	size_t size;
	void * so = LoadFromAcsShaderFileInMemory(name, combo, size);
...
void CAfxShaders::BeginDevice(ID3D11Device * device)
{
	EndDevice();
