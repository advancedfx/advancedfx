...
if(AFX_PACKAGE_INSTALLER)
    ...
    afx_script_run("${CMAKE_COMMAND}" -E rm -Rf "${AFX_PACKAGE_PREFIX}/installer/hlae/locales")
    afx_script_run("${CMAKE_COMMAND}" -E rm -f "${AFX_PACKAGE_PREFIX}/installer/hlae/HLAE.exe")
