...
public:
	...
	virtual bool GetDemoTickFromTime(double curTime, double time, int& outTick) abstract = 0;
	virtual bool GetDemoTimeFromTime(double curTime, double time, double& outDemoTime) abstract = 0;
};
